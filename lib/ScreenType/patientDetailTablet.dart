...
class PatientDetailsTablet extends StatefulWidget {
  DocumentSnapshot snapshot;
  PatientDetailsTablet(this.snapshot);
  @override
  _PatientDetailsTabletState createState() => _PatientDetailsTabletState();
}

class _PatientDetailsTabletState extends State<PatientDetailsTablet> {

  final TextStyle labelTextStyle = TextStyle(
      fontSize: 18, color: Color(0xff1e272e));
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Image.asset('images/weblogo.png', fit: BoxFit.contain,height:130),
